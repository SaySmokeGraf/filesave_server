...
1. > **[Функционал](#функционал)**
    1. > **[Бэкенд](#бэкенд)**
    1. > **[Фронтенд](#фронтенд)**
    1. > **[Связь бэкенда и фронтенда](#связь-бэкенда-и-фронтенда)**
    1. > **[Документация](#документация)**
1. > **[Использование](#использование)**
    1. > **[Зависимости](#зависимости)**
    1. > **[Порядок](#порядок)**
1. > **[Роадмап разработки](#роадмап-разработки)**
...
- [ ] **v.1.0.0**: Сервис для сохранения файлов на удаленный сервер.
    - [ ] **v.0.1.0**: Простейшее приложение.
        ...
        - [x] **v.0.0.1**: Основной функционал.
        - [x] **v.0.0.2**: Простейшая безопасность и удобство
            использования.
    ...
    - [ ] **v.0.3.0**: Большое обновление безопасности.
        - [ ] **v.0.2.1**: Изменение порядка взаимодействия с
            загружаемым файлом.
        - [ ] **v.0.2.2**: Защита файлов.
        - [ ] **v.0.2.3**: Более безопасное хранение и использование
