...
Центральная идея: модерируемый закрытый сервер для локального или
глобального использования несколькими людьми с целью создания отдельного
хранилища под свои нужды.
...
- API аутентификации-авторизации - для входа на сервис. Возвращают
    ...
    проверки токена.
- API модерирования - для модерирования пользователей.
...
- Страницы:
    ...
    - Страница для регистрации и входа.
...
- [ ] **v.1.0.0**: Сервис для сохранения файлов на удаленный сервер.
    - [ ] **v.0.1.0**: Простейшее приложение.
        ...
        - [x] **v.0.0.2**: Простейшая безопасность и удобство
            использования.
        - [x] **v.0.0.3**: Модерация и регистрация.
        - [ ] **v.0.0.4**: Тестирующая оболочка.
        - [ ] **v.0.0.5**: Переход в микросервисную архитектуру.
        - [ ] **v.0.0.6**: Расширение функционала профиля пользователя.
        - [ ] **v.0.0.7**: Администрирование. Контроль параметров
            запуска. Миграции и обновления.
        - [ ] Правки, QOL, тестирование и подготовка.
    - [ ] **v.0.2.0**: Большое обновление безопасности.
        - [ ] **v.0.1.1**: Изменение порядка взаимодействия с
            загружаемым файлом.
        - [ ] **v.0.1.2**: Защита файлов.
        - [ ] **v.0.1.3**: Более безопасное хранение и использование
